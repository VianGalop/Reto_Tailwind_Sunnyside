...
import graphiDesignMobile from '../assets/mobile/image-graphic-design.jpg'
import graphiDesignDesktop from '../assets/desktop/image-graphic-design.jpg'
...
export const Services = () => {
  return (
   <section className="tablet:grid tablet:grid-cols-2">
    ...
    <ImageText 
        order ='order-5'
        imgMobile = {graphiDesignMobile}
        imgDesktop = {graphiDesignDesktop}
