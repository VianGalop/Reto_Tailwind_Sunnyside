  ...
  return (
    <nav className='font-Barlow'>
      ...
      lg:w-[490px]`}>
        ...
        <li className='cursor-pointer bg-Yellow-color  w-[140px] h-[56px] grid place-content-center rounded-full text-Very-dark-desaturated-blue uppercase font-Fraunces 
